...
The Mau CLI is a command-line interface tool that lets you deploy your NestJS applications to the cloud (Mau). Visit [Mau](https://mau.nestjs.com) for more information.
