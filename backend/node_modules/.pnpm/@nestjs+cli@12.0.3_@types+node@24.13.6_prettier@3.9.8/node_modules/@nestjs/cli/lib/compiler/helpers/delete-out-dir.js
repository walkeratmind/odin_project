...
import { areOutsidePathsAllowed, assertPathInsideProject, } from './path-confinement.js';
/**
...
export async function deleteOutDirIfEnabled(configuration, appName, dirPath, tsOptions) {
    ...
    const tsBuildInfoFile = tsOptions &&
    ...
    const outDirToDelete = shouldValidate
        ...
        : dirPath;
    const tsBuildInfoFileToDelete = shouldValidate && tsBuildInfoFile
