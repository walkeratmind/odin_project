...
export class BuildCommand extends AbstractCommand {
    load(program) {
        program
            ...
            .option('--type-check', 'Enable type checking (when SWC is used).', () => true)
            .option('--no-type-check', 'Disable type checking (when SWC is used).', () => false)
            .option('--emit-declarations', 'Emit declaration files (.d.ts) when using SWC builder.')
            ...
            .option('--parallel [concurrency]', 'Build projects in parallel (with --all). Optionally limit concurrency.')
            ...
            const context = {
                ...
                preserveWatchOutput: !!options.watch && !isWebpackEnabled
