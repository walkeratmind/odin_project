...
import { NestExpressBodyParserOptionsFor, NestExpressBodyParserType } from './nest-express-body-parser.interface.js';
...
export interface NestExpressApplication<TServer extends CoreHttpServer | CoreHttpsServer = CoreHttpServer> extends INestApplication<TServer> {
     ...
     * @returns {this}
     */
    useBodyParser<ParserType extends NestExpressBodyParserType>(parser: ParserType, options?: NestExpressBodyParserOptionsFor<ParserType>): this;
    /**
